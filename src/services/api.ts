...
export const agentesApi = {
  ...
  extrairScript:    (file: File, tipo?: string) => {
...
export const inteligenciaApi = {
  ...
  aprovarCross: (id: string) => api.post(`/inteligencia/cross/${id}/aprovar`, {}),
  rejeitarCross: (id: string) => api.delete(`/inteligencia/cross/${id}`),
